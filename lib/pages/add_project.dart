...
class _AddProjectState extends State<AddProject> {
  ...
  final TextEditingController readmecontroller = TextEditingController();
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              customTextField(readmecontroller, TextInputType.text, 5),
              SizedBox(
                height: width / 25,
              ),
              Text(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ProjectModel project = ProjectModel(
                      userId: user!.uid,
                      lang: _items,
                      startDate: DateTime.parse(publishDatecontroller.toString()),
                      issuer: user!.displayName,
                      projectName: projectcontroller.text,
                      imageUrl: downloadUrl,
                    );
                    databaseService.addProjectToUser(
                      user!.uid, project
                    );
                  },
                  style: ButtonStyle(
  ...
  void _convertStringToList() {
    setState(() {
      // Access the text from the controller and split it into a list
      _items = langcontroller.text.split(',').map((item) => item.trim()).toList();
    });
  }
}
